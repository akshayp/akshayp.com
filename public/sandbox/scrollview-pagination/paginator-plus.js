/* global YUI */
YUI.add('scrollview-paginator-plus', function (Y) {
/**
 ...
 */
     ...
     */
        _calcOffsets: function () {
            ...
            var vert = host._scrollsVertical;
            var size = (vert) ? host._scrollHeight : host._scrollWidth;
            var pageSelector = this.get('selector');
            var pages;
            var offsets;
